...
class GatGEBert(nn.Module, AbstractGraphSapMetricLearningModel):
    def __init__(self, bert_encoder, gat_num_outer_layers: int, gat_num_inner_layers, gat_dropout_p: float,
                 ...
                 gat_add_self_loops, graph_loss_weight: float, intermodal_loss_weight: float,
